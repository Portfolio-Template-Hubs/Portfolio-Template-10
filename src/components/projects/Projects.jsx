...
const Projects = () => {
  ...
  return (
    <section id='projects' className="py-32 relative overflow-hidden min-h-screen" style={{ background: `linear-gradient(135deg, var(--bg-secondary), var(--bg-tertiary), var(--bg-secondary))` }}>
